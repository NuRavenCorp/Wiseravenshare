...
public sealed class YouTubeService : IYouTubeService
{
    ...
    public Task<string> UploadFacebookVideoAsync(IFormFile videoFile, string title, string description)
    {
        return Task.FromResult($"https://www.facebook.com/wiseravenshare/videos/{GenerateSlug()}");
    }
