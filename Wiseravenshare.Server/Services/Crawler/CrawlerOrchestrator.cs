    ...
    private async Task EnsureCrawlerTablesAsync(CancellationToken ct)
    {
        await _db.Database.ExecuteSqlRawAsync("""
            ...
            CREATE TABLE IF NOT EXISTS app_data.crawl_jobs (
                ...
                render_java_script boolean NOT NULL,
                capture_screenshots boolean NOT NULL,
                follow_external_links boolean NOT NULL,
                include_patterns text[] NULL,
                exclude_patterns text[] NULL,
                custom_user_agents text[] NULL,
                ...
                overall_health_score numeric(18,2) NOT NULL,
                seo_score numeric(18,2) NOT NULL,
                performance_score numeric(18,2) NOT NULL,
                accessibility_score numeric(18,2) NOT NULL,
                security_score numeric(18,2) NOT NULL,
                content_score numeric(18,2) NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS app_data.crawled_pages (
                ...
                style_sheet_count integer NOT NULL,
                has_h1 boolean NOT NULL,
                h1_count integer NOT NULL,
                h2_count integer NOT NULL,
                h3_count integer NOT NULL,
                has_meta_robots boolean NOT NULL,
                meta_robots text NULL,
                has_canonical boolean NOT NULL,
                has_viewport_meta boolean NOT NULL,
                has_open_graph boolean NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS app_data.crawl_issues (
                ...
                fixed_at timestamp with time zone NULL,
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ix_crawled_pages_job_url ON app_data.crawled_pages(crawl_job_id, url);
            CREATE INDEX IF NOT EXISTS ix_crawl_issues_job_category_severity ON app_data.crawl_issues(crawl_job_id, category, severity);
            CREATE INDEX IF NOT EXISTS ix_crawl_links_job_source ON app_data.crawl_links(crawl_job_id, source_url);
            CREATE INDEX IF NOT EXISTS ix_crawl_links_job_target ON app_data.crawl_links(crawl_job_id, target_url);
            CREATE INDEX IF NOT EXISTS ix_crawl_metrics_job_key_time ON app_data.crawl_metrics(crawl_job_id, metric_key, recorded_at);
            """, ct);
    }
}
