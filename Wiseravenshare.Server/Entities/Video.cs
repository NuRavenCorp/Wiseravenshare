...
namespace Wiseravenshare.Server.Entities
{
    ...
    public class Ravensight_Video : BaseEntity
    {
        public Guid UserId { get; set; }
    ...
    public enum Ravensight_VideoPublishStatus
    {
        Pending,
        Processing,
        Published,
    ...
    public enum Ravensight_VideoStatus
    {
        Processing,
        Ready,
        Failed,
    ...
    public class Ravensight_VideoLike : BaseEntity
    {
    ...
    public class Ravensight_VideoComment : BaseEntity
    {
        public Guid VideoId { get; set; }
        public Guid UserId { get; set; }
