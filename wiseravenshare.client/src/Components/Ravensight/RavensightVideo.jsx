...
const RavensightVideo = () => {
    ...
    const subscribeNow = (billingCycle = 'monthly') => {
        ...
        addNotification(
            isAnnual
                ? `Subscribed to ${CREATOR_PRO.tier} at $${CREATOR_PRO.annualPrice.toFixed(2)}/year.`
                : `Subscribed to ${CREATOR_PRO.tier} at $${CREATOR_PRO.monthlyPrice.toFixed(2)}/month.`,
            'success'
        );
    };
