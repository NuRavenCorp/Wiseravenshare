// Application/Services/Assistant/TextToSpeechService.cs
using System.Text;
...
{
    public string Provider { get; set; } = "openai"; // openai | elevenlabs | azure
...
public class TextToSpeechService : ITextToSpeechService
{
    ...
    {
        // Average speaking rate: ~150 words/min => 400ms/word
